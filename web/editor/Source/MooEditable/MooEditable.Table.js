...
Object.append(MooEditable.Actions, {
    ...
    tableadd: {
        question: MooEditable.Locale.get('addTable'),
        dialogs: {
    ...
    tableedit: {
        question: MooEditable.Locale.get('editTable'),
        dialogs: {
            prompt: function (editor) {
    ...
    tablerowedit: {
        question: MooEditable.Locale.get('editTableRow'),
        dialogs: {
            prompt: function (editor) {
    ...
    tablerowspan: {
        question: MooEditable.Locale.get('mergeTableRow'),
        command: function () {
    ...
    tablerowsplit: {
        question: MooEditable.Locale.get('splitTableRow'),
        command: function () {
            var node = this.selection.getNode();
            if (node.get('tag') != 'td') node = node.getParent('td');
            if (node) {
    ...
    tablerowdelete: {
        question: MooEditable.Locale.get('deleteTableRow'),
        command: function () {
            var node = this.selection.getNode().getParent('tr');
    ...
    tablecoladd: {
        question: MooEditable.Locale.get('addTableCol'),
        command: function () {
            var node = this.selection.getNode();
            if (node.get('tag') != 'td') node = node.getParent('td');
            if (node) {
    ...
    tablecoledit: {
        question: MooEditable.Locale.get('editTableCol'),
        dialogs: {
            prompt: function (editor) {
    ...
    tablecolspan: {
        question: MooEditable.Locale.get('mergeTableCell'),
        command: function () {
            var node = this.selection.getNode();
            if (node.get('tag') != 'td') node = node.getParent('td');
            if (node) {
    ...
    tablecolsplit: {
        question: MooEditable.Locale.get('splitTableCell'),
        command: function () {
            var node = this.selection.getNode();
            if (node.get('tag') != 'td') node = node.getParent('td');
            if (node) {
    ...
    tablecoldelete: {
        question: MooEditable.Locale.get('deleteTableCol'),
        command: function () {
            var node = this.selection.getNode();
            if (node.get('tag') != 'td') node = node.getParent('td');
            if (node) {

...
Object.append(MooEditable.Actions, {
    ...
    formatBlock: {
        question: MooEditable.Locale.get('blockFormatting'),
        type: 'menu-list',
        options: {
            list: [
    ...
    justifyleft: {
        question: MooEditable.Locale.get('alignLeft'),
        states: {
            css: {'text-align': 'left'}
        }
    },
    ...
    justifyright: {
        question: MooEditable.Locale.get('alignRight'),
        states: {
    ...
    justifycenter: {
        question: MooEditable.Locale.get('alignCenter'),
        states: {
            tags: ['center'],
    ...
    justifyfull: {
        question: MooEditable.Locale.get('alignJustify'),
        states: {
    ...
    removeformat: {
        question: MooEditable.Locale.get('removeFormatting')
    },

    insertHorizontalRule: {
        question: MooEditable.Locale.get('insertHorizontalRule'),
        states: {
            tags: ['hr']
        },
        command: function () {

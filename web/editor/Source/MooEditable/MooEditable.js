...
// Wrapper functions to be used internally and for plugins, defaults to en-US
    ...
    MooEditable.UI.Button = new Class({
        ...
        render: function () {
            ...
            var text = this.options.question || name;
    ...
    MooEditable.Actions = {
        ...
        bold: {
            question: MooEditable.Locale.get('bold'),
            options: {
                shortcut: 'b'
            },
            states: {
        ...
        italic: {
            question: MooEditable.Locale.get('italic'),
            options: {
                shortcut: 'i'
            },
            states: {
        ...
        underline: {
            question: MooEditable.Locale.get('underline'),
            options: {
                shortcut: 'u'
            },
            states: {
        ...
        strikethrough: {
            question: MooEditable.Locale.get('strikethrough'),
            options: {
                shortcut: 's'
            },
            states: {
        ...
        insertunorderedlist: {
            question: MooEditable.Locale.get('unorderedList'),
            states: {
                tags: ['ul']
            }
        },
        ...
        insertorderedlist: {
            question: MooEditable.Locale.get('orderedList'),
            states: {
                tags: ['ol']
            }
        },
        ...
        indent: {
            question: MooEditable.Locale.get('indent'),
            states: {
                tags: ['blockquote']
            }
        },
        ...
        outdent: {
            question: MooEditable.Locale.get('outdent')
        },

        undo: {
            question: MooEditable.Locale.get('undo'),
            options: {
                shortcut: 'z'
            }
        },
        ...
        redo: {
            question: MooEditable.Locale.get('redo'),
            options: {
                shortcut: 'y'
            }
        },
        ...
        unlink: {
            question: MooEditable.Locale.get('removeHyperlink')
        },

        createlink: {
            question: MooEditable.Locale.get('addHyperlink'),
            options: {
                shortcut: 'l'
            },
            states: {
        ...
        urlimage: {
            question: MooEditable.Locale.get('addImage'),
            options: {
                shortcut: 'm'
            },
            dialogs: {
        ...
        toggleview: {
            question: MooEditable.Locale.get('toggleView'),
            command: function () {
